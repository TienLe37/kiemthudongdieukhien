...
class TestTinhGiaCuocGrab(unittest.TestCase):
    ...
    def test_km_tu_0_1_den_1(self):
        ...
        for km in test_cases:
            gia_cuoc = tinh_gia_cuoc_grab(km)
